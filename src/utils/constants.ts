...
// Base URL for HiAnime provider (configurable via ANIME_BASE_URL)
// previously zoro.to -> aniwatch.to -> aniwatchtv.to -> hianimez.to -> hianime.to
const BASE_URL = process.env.ANIME_BASE_URL || "https://aniwatchtv.to";

export const SRC_BASE_URL = BASE_URL;
export const SRC_AJAX_URL = `${BASE_URL}/ajax`;
export const SRC_HOME_URL = `${BASE_URL}/home`;
export const SRC_SEARCH_URL = `${BASE_URL}/search`;
